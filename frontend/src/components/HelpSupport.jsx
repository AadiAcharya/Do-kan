  ...
  return (
    <div className="border-b border-gray-100 last:border-b-0">
      ...
      >
        ...
        <span
          className={
            "flex-shrink-0 w-6 h-6 rounded-full border border-gray-200 flex items-center justify-center text-gray-400 text-sm transition-transform " +
            (open ? "rotate-45" : "")
          }
        >
          +
        ...
        <div className="max-w-5xl mx-auto px-4 py-12 text-center">
          ...
          <div className="max-w-md mx-auto">
            <input
              ...
              className="w-full px-4 py-3 rounded-xl text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          </div>
        </div>
      </div>
                ...
                >
                  ...
                  <div>
                    {section.items.map((item, idx) => (
                      <FaqItem key={section.category + "-" + idx} q={item.q} a={item.a} />
                    ))}
                  </div>
                </div>
              ))
        ...
        <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-2xl border border-gray-100 p-6">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Chat with our support team for quick help with orders and payments.
            </p>
